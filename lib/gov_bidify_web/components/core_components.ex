defmodule GovBidifyWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GovBidifyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GovBidifyWeb.Gettext, "errors", msg, opts)
    end
  end
