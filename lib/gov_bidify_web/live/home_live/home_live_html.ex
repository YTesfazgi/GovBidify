defmodule GovBidifyWeb.HomeLiveHTML do
  ...
  def mobile_search_bar(assigns) do
    ...
    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
      <form phx-submit="search" class="relative flex flex-1">
        ...
        <input id="search-field" class="block h-full w-full border-0 py-0 pl-11 pr-0 text-gray-900 rounded-2xl placeholder:text-gray-400 focus:ring-0 sm:text-sm" placeholder="Search..." value={@query} type="search" name="query">
      </form>
    </div>
    """
  end
