defmodule GovBidify.Opportunities.Opportunity do
  ...
  @derive {
    Flop.Schema,
    filterable: [:type, :naics_code, :cgac, :set_aside, :aac_code, :pop_city, :pop_state, :pop_zip, :pop_country, :department_ind_agency, :sub_tier, :office, :active],
    sortable: [:title, :response_deadline, :type, :department_ind_agency]
  }
