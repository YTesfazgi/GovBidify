defmodule GovBidify.Opportunities do
  ...
  def search(search_term, flop) do
    ...
    flop = Flop.nest_filters(flop, [:type, :department_ind_agency, :sub_tier, :office, :set_aside, :naics_code, :psc_code, :pop_country, :pop_city, :pop_state, :active], operators: %{type: :in, department_ind_agency: :in, sub_tier: :in, office: :in, set_aside: :in, naics_code: :in, psc_code: :in, pop_country: :in, pop_city: :in, pop_state: :in, active: :in})
